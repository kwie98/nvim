...
hi(0, "CmpDocumentation", { bg = c.bg1, fg = c.fg })
hi(0, "CmpDocumentationBorder", { bg = c.bg1, fg = c.bg2 })
hi(0, "CmpItemAbbr", { fg = c.fg })
hi(0, "CmpItemAbbrDefault", { fg = c.fg })
hi(0, "CmpItemAbbrDeprecated", { fg = c.deprecated, strikethrough = true })
hi(0, "CmpItemAbbrDeprecatedDefault", { fg = c.gray })
hi(0, "CmpItemAbbrMatch", { fg = c.directory })
hi(0, "CmpItemAbbrMatchDefault", { fg = c.fg })
hi(0, "CmpItemAbbrMatchFuzzy", { fg = c.directory })
hi(0, "CmpItemAbbrMatchFuzzyDefault", { fg = c.fg })
...
hi(0, "CmpItemKindDefault", { fg = c.fg })
...
hi(0, "CmpItemKindSnippet", { fg = c.dark_gray })
...
hi(0, "CmpItemMenuDefault", { fg = c.fg })
hi(0, "CocExplorerFileDirectory", { bold = true, fg = c.fg })
hi(0, "CocExplorerFileRootName", { bold = true, fg = c.fg })
hi(0, "CocExplorerGitAdded", { fg = c.info })
hi(0, "CocExplorerGitContentChange", { fg = c.warning })
hi(0, "CocExplorerGitIgnored", { fg = c.gray })
hi(0, "CocExplorerGitModified", { fg = c.warning })
hi(0, "CocExplorerGitPathChange", { fg = c.purple })
hi(0, "CocExplorerGitPathChange_Internal", { fg = c.purple })
hi(0, "CocExplorerGitUntracked", { fg = c.gray })
hi(0, "CocExplorerNormalFloat", { link = "NormalSB" })
hi(0, "CocInlayHint", { bg = c.bg3, fg = c.gray })
...
hi(0, "DapUIBreakpointsDisabledLine", { fg = c.conceal })
...
hi(0, "GitGutterAdd", { fg = c.info })
hi(0, "GitGutterChange", { fg = c.warning })
hi(0, "GitGutterDelete", { fg = c.error })
...
hi(0, "IndentBlanklineContextStart", { sp = c.orange, underline = true })
...
hi(0, "MiniDiffOverChange", { bg = c.bg4, fg = c.fg })
hi(0, "MiniDiffOverContext", { link = "DiffChange" })
hi(0, "MiniDiffOverDelete", { link = "DiffDelete" })
hi(0, "MiniDiffSignAdd", { fg = c.info })
hi(0, "MiniDiffSignChange", { fg = c.warning })
hi(0, "MiniDiffSignDelete", { fg = c.error })
...
hi(0, "MiniFilesTitleFocused", { bold = true, fg = c.fg })
hi(0, "MiniHipatternsFixme", { bg = c.error, bold = true, fg = c.bg1 })
hi(0, "MiniHipatternsHack", { bg = c.warning, bold = true, fg = c.bg1 })
hi(0, "MiniHipatternsNote", { bg = c.info, bold = true, fg = c.bg1 })
hi(0, "MiniHipatternsTodo", { bg = c.hint, bold = true, fg = c.bg1 })
hi(0, "MiniIconsAzure", { fg = "#218bff" })
hi(0, "MiniIconsBlue", { fg = c.info })
hi(0, "MiniIconsCyan", { fg = c.cyan })
hi(0, "MiniIconsGreen", { fg = c.info })
hi(0, "MiniIconsGrey", { fg = c.fg })
hi(0, "MiniIconsOrange", { fg = c.orange })
hi(0, "MiniIconsPurple", { fg = c.purple })
hi(0, "MiniIconsRed", { fg = c.keyword })
...
hi(0, "MiniJump2dSpot", { bold = true, fg = c.red })
hi(0, "MiniJump2dSpotAhead", { fg = c.info, nocombine = true })
hi(0, "MiniJump2dSpotUnique", { bold = true, fg = c.warning })
hi(0, "MiniMapNormal", { link = "NormalFloat" })
hi(0, "MiniMapSymbolCount", { link = "Special" })
hi(0, "MiniMapSymbolLine", { fg = c.info })
...
hi(0, "MiniPickMatchRanges", { fg = c.warning })
hi(0, "MiniPickNormal", { link = "NormalFloat" })
hi(0, "MiniPickPreviewLine", { link = "CursorLine" })
hi(0, "MiniPickPreviewRegion", { link = "IncSearch" })
hi(0, "MiniPickPrompt", { fg = c.blue })
hi(0, "MiniStarterCurrent", { nocombine = true })
hi(0, "MiniStarterFooter", { fg = c.conceal, italic = true })
hi(0, "MiniStarterHeader", { fg = c.info })
hi(0, "MiniStarterInactive", { link = "Comment" })
hi(0, "MiniStarterItem", { link = "Normal" })
hi(0, "MiniStarterItemBullet", { fg = c.hint })
hi(0, "MiniStarterItemPrefix", { fg = c.warning })
hi(0, "MiniStarterQuery", { fg = c.info })
hi(0, "MiniStarterSection", { link = "Special" })
hi(0, "MiniStatuslineDevinfo", { bg = c.bg4, fg = c.fg })
hi(0, "MiniStatuslineFileinfo", { bg = c.bg4, fg = c.fg })
hi(0, "MiniStatuslineFilename", { bg = c.bg0, fg = "#8d8f92" })
hi(0, "MiniStatuslineInactive", { bg = c.bg1, fg = "#8d8f92" })
hi(0, "MiniStatuslineModeCommand", { bg = "#a475f9", bold = true, fg = c.bg0 })
hi(0, "MiniStatuslineModeInsert", { bg = c.blue, bold = true, fg = c.bg0 })
hi(0, "MiniStatuslineModeNormal", { bg = c.info, bold = true, fg = c.bg0 })
hi(0, "MiniStatuslineModeOther", { bold = true, fg = c.bg0 })
hi(0, "MiniStatuslineModeReplace", { bg = c.keyword, bold = true, fg = c.bg0 })
hi(0, "MiniStatuslineModeVisual", { bg = "#4d2d00", bold = true, fg = c.bg0 })
hi(0, "MiniSurround", { link = "IncSearch" })
hi(0, "MiniTablineCurrent", { bg = "#59a8ff", bold = true, fg = c.bg1 })
hi(0, "MiniTablineFill", { link = "TabLineFill" })
hi(0, "MiniTablineHidden", { bg = c.bg0, fg = c.fg })
hi(0, "MiniTablineModifiedCurrent", { bg = c.bg1, bold = true, fg = "#59a8ff" })
hi(0, "MiniTablineModifiedHidden", { bg = c.fg, fg = c.bg0 })
hi(0, "MiniTablineModifiedVisible", { bg = c.bg1, fg = "#90c5ff" })
hi(0, "MiniTablineTabpagesection", { bg = "#c2e2ff", bold = true })
hi(0, "MiniTablineVisible", { bg = "#90c5ff", fg = c.bg1 })
hi(0, "MiniTestEmphasis", { bold = true })
hi(0, "MiniTestFail", { bold = true, fg = c.keyword })
hi(0, "MiniTestPass", { bold = true, fg = c.blue })
hi(0, "MiniTrailspace", { bg = c.keyword })
hi(0, "ModeMsg", { bold = true, fg = c.warning })
hi(0, "MoreMsg", { bold = true, fg = c.info })
hi(0, "NeoTreeDimText", { link = "Conceal" })
hi(0, "NeoTreeDirectoryIcon", { fg = c.fg })
hi(0, "NeoTreeDirectoryName", { fg = c.fg })
hi(0, "NeoTreeDotfile", { fg = "#84b4ed" })
hi(0, "NeoTreeEndOfBuffer", { fg = c.bg1 })
hi(0, "NeoTreeFileName", { fg = c.fg })
hi(0, "NeoTreeFileNameOpened", { fg = "#218bff" })
hi(0, "NeoTreeGitAdded", { fg = c.info })
hi(0, "NeoTreeGitConflict", { fg = c.keyword, italic = true })
hi(0, "NeoTreeGitDeleted", { fg = c.error })
hi(0, "NeoTreeGitIgnored", { fg = c.conceal })
hi(0, "NeoTreeGitModified", { fg = c.warning })
hi(0, "NeoTreeGitUntracked", { fg = "#32898f" })
hi(0, "NeoTreeIndentMarker", { fg = c.conceal })
hi(0, "NeoTreeNormal", { link = "NormalSB" })
hi(0, "NeoTreeNormalNC", { link = "NeoTreeNormal" })
hi(0, "NeoTreeRootName", { bold = true, fg = c.fg })
hi(0, "NeoTreeSymbolicLinkTarget", { fg = "#df9cc4" })
hi(0, "NeoTreeTitleBar", { bg = "#2278de", fg = c.bg0 })
hi(0, "NeogitBranch", { fg = c.warning })
hi(0, "NeogitDiffAdd", { fg = c.info })
hi(0, "NeogitDiffAddHighlight", { bg = c.added })
hi(0, "NeogitDiffContextHighlight", { bg = c.bg3 })
hi(0, "NeogitDiffDelete", { fg = c.error })
hi(0, "NeogitDiffDeleteHighlight", { bg = "#dcc8b3" })
hi(0, "NeogitHunkHeader", { bg = c.bg4, fg = c.info })
hi(0, "NeogitHunkHeaderHighlight", { bg = c.bg2, fg = c.info })
hi(0, "NeogitNotificationError", { fg = c.error })
hi(0, "NeogitNotificationInfo", { fg = c.info })
hi(0, "NeogitNotificationWarning", { fg = c.warning })
hi(0, "NeogitRemote", { fg = c.hint })
...
hi(0, "NvimTreeEndOfBuffer", { fg = c.bg1 })
hi(0, "NvimTreeFolderName", { fg = c.fg })
hi(0, "NvimTreeGitDeleted", { fg = c.error })
hi(0, "NvimTreeGitDirty", { fg = c.warning })
hi(0, "NvimTreeGitIgnored", { fg = c.gray })
hi(0, "NvimTreeGitNew", { fg = c.info })
hi(0, "NvimTreeGitRenamed", { fg = c.purple })
hi(0, "NvimTreeImageFile", { fg = "#633c01" })
hi(0, "NvimTreeIndentMarker", { fg = c.gray })
hi(0, "NvimTreeNormal", { link = "NormalSB" })
hi(0, "NvimTreeOpenedFile", { fg = "#218bff" })
hi(0, "NvimTreeOpenedFolderName", { bold = true, fg = c.fg })
hi(0, "NvimTreeRootFolder", { bold = true, fg = c.fg })
hi(0, "NvimTreeSpecialFile", { fg = "#4d2d00", underline = true })
hi(0, "NvimTreeSymlink", { fg = c.purple })
...
hi(0, "Removed", { bg = "#dcc8b3", fg = c.error })
