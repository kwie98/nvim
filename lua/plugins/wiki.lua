return {
    {
        ...
        config = function()
            ...
            telekasten.setup({
                ...
                template_new_note = wiki_folder .. "/" .. "templates/new_note.md",
                -- template for newly created daily notes (goto_today)
                -- set to `nil` or do not specify if you do not want a template
                template_new_daily = wiki_folder .. "/" .. "templates/daily.md",
                -- template for newly created weekly notes (goto_thisweek)
                -- set to `nil` or do not specify if you do not want a template
                template_new_weekly = wiki_folder .. "/" .. "templates/weekly.md",
                -- image link style
                -- wiki:     ![[image name]]
