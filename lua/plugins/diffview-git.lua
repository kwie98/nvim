local function diffview() return require("diffview") end
return {
    "sindrets/diffview.nvim",
    keys = {
        { "<Leader>gd", function() diffview().open() end, desc = "Diffview" },
        { "<Leader>gh", function() diffview().file_history() end, desc = "History" },
        { "<Leader>gf", function() diffview().file_history(nil, { "%" }) end, desc = "History of this File" },
    },
